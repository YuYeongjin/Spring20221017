...
<body>
	...
	이메일 : <input type="email" name="email" value=aa@daum.net> <br>
	...
	<form action="${pageContext.request.contextPath }/ex13/sub03">
		...
		<br>
		학급 : <input type="text" name="className">
		<br>
		학생 : <input type="text" name="studentNumber">
		<br>
		과목 : <input type="text" name="location">
		<br>
